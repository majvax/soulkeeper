...
return function(mod)
    ...
    mod:add_stat_upgrade("core:firerate", "Rapid Fire", { 0.03, 0.06, 0.10 },
        function(e, _, amount)
            local w = e:get(Weapon)
    ...
    mod:add_stat_upgrade("core:movespeed", "Swift Boots", { 20, 35, 60 },
        function(e, _, amount)
            local s = e:get(Speed)
    ...
    mod:add_stat_upgrade("core:maxhp", "Vitality", { 20, 40, 70 },
        function(e, _, amount)
    ...
    mod:add_stat_upgrade("core:aoezone", "AOE Zone", { 20, 35, 55 },
        function(e, _, amount)
